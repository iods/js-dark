...
class Thermostat{
  ...
  get temperature(){ //return in celcius from fahrenheit input
      return 5/9 * (this.fahrenheit-32)
  }
  set temperature(celcius){ //set celcius to fahrenheit
...
//this is still confusing I will have to comeback and try to understand it fully.